              ...
              <div className="row">
                <div className="col-lg-5 text">
                  ...
                  During my time at the College of Computer Studies,
                   I've learned a  about programming languages like C++, 
            ...
            <div class="row">
              ...
              <div class="col-md-3 text-center mb-3">
                <div class="single-horizontal-timeline">
                  ...
                  <div class="timeline text-center">
                    <div class="timeline-content">
                      <h4 class="title">Hinapunan Integrated School</h4>
                      <p className="text-secondary">
                        Hinapunan Brgy. Oringao, Kabankalan City, Negros Occidental
                      </p>
                    </div>
                  </div>
                </div>
